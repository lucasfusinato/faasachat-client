...
const signoutButton = document.getElementById('signout-icon');

const addForm = document.getElementById('add-form');
const addFormNickname = document.getElementById('add-nickname');
const addFormButton = document.getElementById('add-button');

addBlockContainer.addEventListener('click', function() {
    addBlockContainer.classList.add('hide');
});

addButton.addEventListener('click', function() {
    addFormNickname.value = null;
    addBlockContainer.classList.remove('hide');
    addFormNickname.focus();
});
...
addFormButton.addEventListener('click', function() {
    ...
    ipcRenderer.send('addContact', { nickname: addFormNickname.value });
});
...
ipcRenderer.on('newContact', function(event, contactsList) {
    blockContainer.classList.add('hide');
    updateContactsList(contactsList);
});
...
ipcRenderer.on('chatError', function(event, message) {
